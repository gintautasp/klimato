...
$( function() {
	var dialog, form,
		...
		platuma = $( "#platuma" ),
		ilguma = $( "#ilguma" ),
		skaicius_gyv = $( "#skaicius_gyv" ),
		plotas = $( "#plotas" ),
		duom_gav_laikas = $( "#duom_gav_laikas" ),
	
		allFields = $( [] ).add( pav ).add( kodas_salies ).add( platuma ).add( ilguma ).add( skaicius_gyv ).add( plotas ).add( duom_gav_laikas ) ,
		tips = $( ".validateTips" );
